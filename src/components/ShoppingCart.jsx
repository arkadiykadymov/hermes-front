...
export default class ShoppingCart extends React.Component {
  ...
  handleShoppingCart() {
    axios
      .get(api_url + '/shoppingcart/getCart', {
        headers: {
...
class Product extends React.Component {
  ...
  deleteProductFromShoppingCart() {
    axios
      .get(api_url + '/shoppingcart/deleteProductFromCart/' + this.props.product.name, {
        headers: {
          'Content-Type': 'application/json',
          Authorization: 'Bearer ' + localStorage.getItem('access_token'),
          'Access-Control-Allow-Origin': '*',
  ...
  render() {
    ...
    return (
      <tr>
        ...
        <td>
          <ion-icon name="close-outline" onClick={this.deleteProductFromShoppingCart}></ion-icon>
        </td>
        {this.state.isDelitedAlert ? (
